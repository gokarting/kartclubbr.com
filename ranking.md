...
<section class="kc-table-wrap" aria-label="Championship ranking table">
	<table>
		...
		<tbody>
			<tr><td>1</td><td>NATAL</td><td>25</td></tr>
			<tr><td>2</td><td>NOBLE 6</td><td>22</td></tr>
...
<section class="kc-hero-panel">
	<p class="kc-eyebrow">Points System</p>
	<p>1st to 15th place scoring:</p>
	<p>25, 22, 20, 18, 16, 14, 12, 10, 8, 7, 6, 5, 4, 3, 2</p>
	<p>From 16th place onward: 1 point per position.</p>
</section>
</div>
